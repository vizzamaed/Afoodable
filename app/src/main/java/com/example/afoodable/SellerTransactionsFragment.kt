...
class SellerTransactionsFragment : Fragment() {
    ...
    private lateinit var adapter: SellerTransactionsFragmentAdapter

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val view = inflater.inflate(R.layout.fragment_seller_transactions, container, false)

        tabLayout = view.findViewById(R.id.tabLayout)
        viewPager2 = view.findViewById(R.id.viewPager2)

        adapter = SellerTransactionsFragmentAdapter(childFragmentManager, lifecycle)
