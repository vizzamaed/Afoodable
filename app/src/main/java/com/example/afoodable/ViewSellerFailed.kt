...
import com.example.afoodable.databinding.ActivityViewSellerFailedBinding
...
class ViewSellerFailed : AppCompatActivity() {
    var imageURL = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityViewSellerFailedBinding.inflate(layoutInflater)
