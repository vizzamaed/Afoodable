...
import com.example.afoodable.databinding.ActivityViewCancelledBinding
...
class ViewCancelled : AppCompatActivity() {
    var imageURL = ""
    ...
    private lateinit var binding: ActivityViewCancelledBinding
    private lateinit var databaseReference: DatabaseReference


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityViewCancelledBinding.inflate(layoutInflater)
